...
CREATE TABLE `administrator` (
  ...
  `sifra` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  PRIMARY KEY (`adminId`)
...
/*Table structure for table `procitane` */

DROP TABLE IF EXISTS `procitane`;

CREATE TABLE `procitane` (
  `clanId` bigint unsigned NOT NULL,
  `knjigaId` bigint unsigned NOT NULL,
  PRIMARY KEY (`clanId`,`knjigaId`),
  KEY `knjiga_p_fk` (`knjigaId`),
  CONSTRAINT `clan_p_fk` FOREIGN KEY (`clanId`) REFERENCES `clan` (`clanId`),
  CONSTRAINT `knjiga_p_fk` FOREIGN KEY (`knjigaId`) REFERENCES `knjiga` (`knjigaId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;

/*Data for the table `procitane` */

insert  into `procitane`(`clanId`,`knjigaId`) values 
(7,1),
(19,1),
(24,6),
(7,9),
